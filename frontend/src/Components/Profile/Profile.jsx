...
const Profile = () => {
            ...
            const fetchProfileData = async () => {
                ...
                try {
                    ...
                    const endpoint = isViewingOwnProfile
                        ? 'https://curtinunihubplus.com/profile/profile/' 
                        : `https://curtinunihubplus.com/profile/students/${requestedStudentId}/`;
                        ...
                        const processClubImages = (clubs) => {
                            return clubs.map(club => ({
                                ...
                                logo: club.logo ? (club.logo.startsWith('http') ? club.logo : 
                                      `https://curtinunihubplus.com${club.logo}`) : ''
                            }));
                        };
    ...
    const handleProfilePicChange = async (e) => {
        ...
        try {
            ...
            const accessToken = localStorage.getItem('access_token');
            const response = await fetch('https://curtinunihubplus.com/profile/update-picture/', {
                method: 'PUT',
                headers: {
                    'Authorization': `Bearer ${accessToken}`,
                },
