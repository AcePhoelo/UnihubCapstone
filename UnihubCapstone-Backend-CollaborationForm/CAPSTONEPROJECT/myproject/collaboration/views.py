...
#             club_name = form.cleaned_data['your_club']  # Get the selected club name
...
#                 'club_name': club_name,  # Pass the club name to the template
#             })

#             try:
#                 send_mail(
#                     subject=f"Collaboration Request from {club_name}",  # Dynamic subject
