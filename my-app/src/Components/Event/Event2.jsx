    ...
    useEffect(() => {
        const fetchEventDetails = async () => {
                try {
                    ...
                    const eventListResponse = await fetch('https://curtinunihubplus.com/api/event/add_event/', {
                        method: 'GET',
                        headers: {
                    ...
                    const response = await fetch(`https://curtinunihubplus.com/api/event/event_page/event-page/${eventMatch.id}/`, {
                        method: 'GET',
                        headers: {
                            Authorization: `Bearer ${token}`,
                            'Content-Type': 'application/json',
