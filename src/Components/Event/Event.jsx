    ...
    useEffect(() => {
        const fetchEventDetails = async () => {
                try {
                    ...
                    const eventListResponse = await fetch('http://18.141.193.54:8000/api/event/add_event/', {
                        method: 'GET',
                        headers: {
                    ...
                    const response = await fetch(`http://18.141.193.54:8000/api/event/event_page/event-page/${eventMatch.id}/`, {
                        method: 'GET',
                        headers: {
                            Authorization: `Bearer ${token}`,
                            'Content-Type': 'application/json',
